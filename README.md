...
If you have any ideas for ways to improve or use the project, [feel free to open an Issue in Github](https://github.com/okdv/colormap/issues)! Of course you can always fork and do it yourself, but official support is best where possible.

### Get Involved

Interested in contributing or learning how to set up the project locally? Please see our **[CONTRIBUTING.md](https://colormap.app#contributing)** file for details on development setup, testing, and how to submit your contributions.

## Roadmap

Target is v1.0.0first stable/non beta release

Timeline: aiming for September or October

Schedule: Roughly weekly beta releases until then

Major Features planned for v1.0.0 (first stable/non-beta release)

[ ] Upload your own Interactive Layer

[ ] Import/Export State

[ ] Snapshot of Map

[x] Interactive Layer Styling (e.g. selected feature opacity)

[ ] Map Styling (e.g. base layer)

[ ] Dark Mode

[x] US Counties Interactive Layer

[x] US States Interactive Layer

[ ] Countries Interactive Layer

[ ] Congressional Districts Interactive Layer
